...
export function initFootnotes() {
  /** True only on touch-only devices (no fine pointer) */
  const isTouchOnly = window.matchMedia('(pointer: coarse)').matches && !window.matchMedia('(pointer: fine)').matches;

  /* ---------- Tooltip elements ---------- */
  const tooltip = document.getElementById('fn-tooltip');
  const tooltipNum = document.getElementById('fn-tooltip-num');
  const tooltipContent = document.getElementById('fn-tooltip-content');
  const tooltipSource = document.getElementById('fn-tooltip-source');
  const tooltipGoto = document.getElementById('fn-tooltip-goto');
  const tooltipArrow = document.getElementById('fn-tooltip-arrow');

  /* ---------- Panel elements ---------- */
  const panelOverlay = document.getElementById('fn-panel-overlay');
  const panel = document.getElementById('fn-panel');
  const panelBody = document.getElementById('fn-panel-body');
  const panelClose = document.getElementById('fn-panel-close');
  ...
  /**
   * Actually remove visible classes / active state.
   */
  ...
  /**
   * Hide the tooltip after a short delay (for mouseleave grace).
   */
